...
def insertPlayerNames():
    ...
    # initilize the dice pic for soemthing rather than null
    dicePic = dicePicture(1)
    print("player1: ", player1)
    print("player2: ", player2)
    print('global current player: ', currentPlayer)

    return render_template("dice.html", player1=player1, player2=player2, dicePic=dicePic)
